...
function RegistrationForm() {
  ...
  const schema = yup.object().shape({
    ...
    emergencyNo: yup
      ...
      .required(),
    idType: yup.string(),
    govID: yup.string().when("idType", {
      is: "Adhar",
      then: yup.string().matches(/^\d{12}$/, "Aadhar number is not valid"),
        ...
        <div className=" bg-[#F7F7F7] drop-shadow-xl  md:pe-10 rounded ">
              ...
              <div className="col-span-4">
                ...
                <div className="my-5 grid grid-cols-6">
                  ...
                  <div className="col-span-2 me-3 ps-0 sm:col-span-1 sm:me-0">
                    ...
                    <p className="text-red-500">{errors.idType?.message}</p>
                  </div>
                ...
                <div className="sm:flex">
                  ...
                  <div className="sm:w-1/4 w-full sm:my-5 lg:my-0">
                    <input
                      ...
                      className="dark:text block w-auto  bg-transparent  rounded border-gray-300  border-2 bg-gray-50 p-1 text-sm text-gray-400 focus:border-blue-500 focus:ring-blue-500 dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500 me-3"
                    />
                  </div>
                  <div className="sm:px-5 my-5 sm:my-5 lg:my-0 block">
                    <label className="block" htmlFor="EmergencyNo">
                  ...
                  <div className="sm:w-3/5 sm:px-0 sm:my-5 lg:my-0">
                    ...
                    />
                    <p className="text-red-500">{errors.emergencyNo?.message}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="px-5">
            ...
            <div className="flex items-center justify-end pt-8 pb-5">
              <button
                type="submit"
                className="sm:me-4 py-2 w-full hover:bg-red-500 ease-in-out duration-500 hover:text-white rounded border-red-200  border-2 px-5 sm:py-1 text-[11px] font-medium uppercase text-red-600 sm:w-24"
              >
                cancel <small className="underline">(esc)</small>
              </button>
              <button
                type="submit"
                className="ms-4  py-2 w-full drop-shadow-2xl rounded hover:bg-green-600 duration-300 ease-in-out bg-[#247817] px-5 sm:py-1 text-[11px] font-normal uppercase tracking-widest text-white shadow-lg  sm:w-24"
              >
                submit{" "}
